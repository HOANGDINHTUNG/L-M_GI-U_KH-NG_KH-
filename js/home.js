...
function renderHeader() {
  ...
  if (userLogin) {
        ...
        <div class="account-user d-flex gap-2">
          ...
          <div class="d-flex flex-column">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="money">${
                userLogin.role != "ADMIN" ? `${userLogin.assets}` : `+&infin;`
              }</span>
    ...
    featureNav.innerHTML = `
      ...
      <div class="d-flex justify-content-end gap-2">
        <form onsubmit="login(event)" class="d-flex gap-2" id="show-hide">
          <input type="text" name="name" placeholder="Tài khoản" class="border border-1" id="nameLogin"/>
          <input type="password" name="password" placeholder="6-15 ký tự chữ và số " class="border border-1" id="password"/>
